...
set(SOMEIP_API_PATH "${CMAKE_SOURCE_DIR}/cgen/someip-generator/commonapi-someip-generator-linux-x86_64")

function(FDEPLGenerate idlfile)
    #message(STATUS ${SOMEIP_API_PATH})
    ...
    if (NOT EXISTS ${FILE_DEST_FULLPATH})
        execute_process(COMMAND ${SOMEIP_API_PATH} -ll verbose "${CMAKE_CURRENT_SOURCE_DIR}/${idlfile}"
